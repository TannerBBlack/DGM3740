<?php include '_header.php'; ?>
    ...
    <div class="your-class">
        ...
        <picture><source media="(max-width: 450px" srcset="images/carnival-magic-ship-aerial-featsmall.jpg"><img src="images/carnival-magic-ship-aerial-feat.jpg"></picture>
        <picture><source media="(max-width: 450px" srcset="images/cruise-ship-2small.jpg"><img src="images/cruise-ship-2.jpg"></picture>
    </div>
